...
CREATE TABLE `blacklist` (
  ...
  `overdue_books_count` int(11) DEFAULT '0' COMMENT '逾期书籍数量',
  `total_overdue_days` int(11) DEFAULT '0' COMMENT '累计逾期天数',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '加入黑名单时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_active` tinyint(4) DEFAULT '1' COMMENT '是否在黑名单中：1-是，0-已移除',
  PRIMARY KEY (`id`),
...
-- Visit count table for dashboard visit statistics
